  ...
  return (
    <Container>
      ...
      <ThirdSection>
        ...
        >
          <img src="/images/Savings-bro.svg" alt="" />
        </motion.div>
...

{
  /* <div style={{ display: "flex" }} className="buttons">
            <button className="app-buttons">
              <img src="/images/applestore.svg" alt="" /> Get on Iphone
            </button>
            <button className="app-buttons">
              <img src="/images/playstore.svg" alt="" /> Get on Android
            </button>
          </div> */
}
